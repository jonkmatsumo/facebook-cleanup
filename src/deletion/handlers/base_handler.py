...
class DeletionHandler(ABC):
    ...
    def _wait_for_confirmation(self, page: Page, timeout: Optional[int] = None) -> bool:
        """
    ...
    def _click_confirm(self, page: Page, timeout: Optional[int] = None) -> bool:
        """
    ...
    def _wait_for_navigation(
        self, page: Page, expected_url_pattern: str = "allactivity", timeout: Optional[int] = None
    ) -> bool:
        """
