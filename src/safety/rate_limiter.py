...
class RateLimiter:
    ...
    def wait_before_action(self) -> bool:
        ...
        wait_before_action(mean=self.mean_delay, std_dev=self.std_dev, min_delay=self.min_delay)
    ...
    def record_action(self) -> None:
        ...
        logger.debug(
            f"Action recorded. Total: {self.deleted_count}, Last hour: {len(self.action_times)}"
        )
